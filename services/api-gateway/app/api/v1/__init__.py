...
from app.api.v1 import (
    admin,  # pylint: disable=import-error
    agentic,  # pylint: disable=import-error
    ai,  # pylint: disable=import-error
    auth,  # pylint: disable=import-error
)
...
api_router.include_router(regulation.router, prefix="/regulation", tags=["regulation"])
...
api_router.include_router(model_cloning.router, prefix="/model-cloning", tags=["model-cloning"])
...
api_router.include_router(parent_dashboard.router, prefix="/parent", tags=["parent"])
