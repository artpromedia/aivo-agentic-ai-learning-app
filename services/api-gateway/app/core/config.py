...
class Settings(BaseSettings):
    ...
    class Config:
        env_file = "C:/aivo-agentic-ai-learning-app/services/api-gateway/.env"
        case_sensitive = True
...
def get_settings() -> Settings:
    ...
    print(f"🔍 DEBUG: .env file path being searched: {os.path.abspath('.env')}")
    print(f"🔍 DEBUG: .env file exists: {os.path.exists('.env')}")

    settings_instance = Settings()
    print(f"🔍 DEBUG: Loaded DATABASE_URL: {settings_instance.DATABASE_URL}")
