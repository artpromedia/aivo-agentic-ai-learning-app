      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm mb-4">AI Learning for Neurodiverse Children</p>
            <p className="text-xs text-neutral-400 italic mb-4">Founded by Ofem Ekapong Ofem</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/children" className="text-sm hover:text-white transition">For Neurodiverse Children</a></li>
              <li><a href="/parents" className="text-sm hover:text-white transition">For Parents</a></li>
              <li><a href="/educators" className="text-sm hover:text-white transition">For Educators</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/documentation" className="text-sm hover:text-white transition">Documentation</a></li>
              <li><a href="/api-reference" className="text-sm hover:text-white transition">API Reference</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/about#partnership" className="text-sm hover:text-white transition">Our Partnership</a></li>
          ...
          <div>
            ...
            <div className="text-sm space-y-3">
              <div>
                <p className="text-neutral-400">AIVO Learning</p>
                <p className="text-neutral-400">1400 Van Buren</p>
                <p className="text-neutral-400">Minneapolis, MN 55413</p>
              </div>
              <div>
                <p className="text-neutral-400">
                  <a href="mailto:hello@aivolearning.com" className="hover:text-white transition">
                    hello@aivolearning.com
                  </a>
                </p>
                <p className="text-neutral-400">
                  <a href="tel:1-800-248-6435" className="hover:text-white transition">
                    1-800-AIVO-HELP
                  </a>
                </p>
              </div>
              <div>
                <p className="text-xs text-neutral-500">Mon-Fri, 9am-6pm CT</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-800 pt-6 pb-6 text-center">
          <p className="text-xs text-neutral-500 max-w-4xl mx-auto">
            <span className="font-semibold text-neutral-400">Student Privacy:</span> All testimonials and case studies comply with HIPAA and FERPA. 
            Student names are anonymized except where explicit parental consent has been provided (Jayden and Jason Ofem, founders&apos; children). 
            School and district names are used with proper data sharing agreements. 
            Contact us at <a href="mailto:privacy@aivolearning.com" className="text-primary-400 hover:underline">privacy@aivolearning.com</a> for questions.
          </p>
        </div>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          ...
          <div className="flex gap-4 text-xs">
            ...
            <span className="text-success-400">✓ HIPAA Compliant</span>
          </div>
        </div>
      </div>
    </footer>
