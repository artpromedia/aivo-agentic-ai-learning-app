    ...
    <section className="py-20 bg-gradient-to-b from-neutral-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          {/* AIVO */}
          <div className="bg-gradient-to-br from-primary-50 to-primary-50 rounded-3xl p-8 border-2 border-primary-200 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-gradient-to-r from-primary-600 to-primary-600 text-white px-6 py-2 rounded-full flex items-center gap-2">
            ...
            <h3 className="text-2xl font-bold text-primary-600 mb-8 text-center mt-4">
        ...
        {/* Bottom Banner */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-600 rounded-2xl p-8 text-white">
        ...
        <div className="text-center mt-12">
          <a href="/signup/select-role" className="inline-flex items-center gap-2 text-primary-600 font-semibold text-lg hover:text-primary-700 transition">
