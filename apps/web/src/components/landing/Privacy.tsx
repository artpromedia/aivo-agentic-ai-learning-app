...
export function Privacy() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-neutral-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Callout Box */}
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-l-4 border-purple-600 rounded-xl p-8 mb-8">
          <p className="text-lg leading-relaxed">
            <span className="font-bold text-purple-600">Your child's AI model learns only from their data.</span>{' '}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <a href="#privacy" className="inline-flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-700 transition">
            Read Privacy Policy
          ...
          <a href="#security" className="inline-flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-700 transition">
            View Security Docs
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
