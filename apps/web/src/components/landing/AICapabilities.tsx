  ...
  const capabilities = [
    {
      ...
      exampleColor: 'text-purple-700 bg-purple-50 border-purple-200',
    ...
    },
    {
      ...
      exampleColor: 'text-blue-700 bg-blue-50 border-blue-200',
            ...
            return (
              <div key={idx} className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 items-center`}>
                ...
                <div className="flex-1">
                  ...
                  <a href="#learn-more" className={`inline-flex items-center gap-2 ${capability.learnColor} font-semibold hover:gap-3 transition-all`}>
                    Learn More
