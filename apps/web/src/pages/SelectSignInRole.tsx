...
export function SelectSignInRole() {
  ...
  const roles = [
    {
      id: 'parent',
      title: 'Parent',
      description: 'Sign in to access your parent portal and monitor your child\'s learning journey.',
      icon: UserGroupIcon,
      color: 'primary',
      ...
      features: [
        ...
        'Review IEP goals and achievements'
      ]
    },
    {
      id: 'teacher',
      title: 'Teacher',
      description: 'Sign in to access your teacher portal and manage student IEPs and progress.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-4">
            Welcome Back to AIVO
          </h1>
          <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
            Choose your role to sign in to your portal
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-neutral-500">
            ...
            <a href="/signup/select-role" className="text-primary-600 hover:text-primary-700 font-semibold">
              Create one here
            </a>
          </p>
        </div>
